...
import ss4 from './images/ss4.webp'
        ...
        <div>
            ...
            <section className="containerfull bg1 padd50">
                <div className="container">
                    <h1>Đặc sản phong phú</h1>
                    <div className="row">
                        <h2>SeaFood</h2>
                    </div>
                    <div className="row">
                        <div className="boxnews mr2pt">
                            <img src={ss1} style={{ height: "350px" }} alt="" />
                        ...
                        <div className="boxnews mr2pt">
                            <img src={ss2} style={{ height: "350px" }}  alt="" />
                        ...
                        <div className="boxnews mr2pt">
                            <img src={ss3} style={{ height: "350px" }} alt="" />
                        ...
                        <div className="row">
                            <div className="boxnews mr2pt">
                                <img src={ss7} style={{ height: "300px" }} alt="" />
                            ...
                            <div className="boxnews mr2pt">
                                <img src={ss8} style={{ height: "300px" }} alt="" />
                            ...
                            <div className="boxnews">
                                <img src={ss9} style={{ height: "300px" }} alt="" />
                        ...
                        <div className="row">
                            <div className="boxnews mr2pt">
                                <img src={ss4} style={{ height: "500px" }} alt="" />
                            ...
                            <div className="boxnews mr2pt">
                                <img src={ss5} style={{ height: "500px" }} alt="" />
                            ...
                            <div className="boxnews">
                                <img src={ss6} style={{ height: "500px" }} alt="" />
